...
void print_syntax_error(runtime_params *datash, char *input, int i, int bool);
int check_syntax_error(runtime_params *datash, char *input);

error1.c 
char *strcat_cd(input_params *, char *, char *, char *);
char *error_get_cd(input_params *datash);
char *error_not_found(input_params *datash);
char *error_exit_shell(runtime_params *datash);
...
char *error_path_126(runtime_params *datash);
